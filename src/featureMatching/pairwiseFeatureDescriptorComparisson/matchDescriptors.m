...
database_descriptors = double(database_descriptors)';
query_descriptors = double(query_descriptors)';

[dists,matches] = pdist2(database_descriptors, ...
    query_descriptors, 'euclidean', 'Smallest', 1);
