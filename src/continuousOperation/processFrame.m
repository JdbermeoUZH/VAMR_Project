function [State_now, T_wc_now, State_before] = processFrame(Image_now, Image_before, State_before, ...
                                 T_wc_before, K, hyperparameters)
...
[State_now, T_wc_now, State_before] = estimateCurrentPose(Image_now, Image_before,... 
